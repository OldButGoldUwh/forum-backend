...
func main() {
	...
	r.HandleFunc("/api/v1/comments/updateLike/{id}", controllers.UpdateLikeForComment).Methods("UPDATE")
	r.HandleFunc("/api/v1/posts/updateLike/{id}", controllers.UpdateLikeForPost).Methods("UPDATE")
